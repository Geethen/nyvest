...
`reports/active_learning/timber_spike.md`; memory: timber-multiclass-nogo.
...
- Short README in `scripts/active_learning/` (how to launch, port-forward, regenerate map).
