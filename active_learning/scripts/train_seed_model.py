...
spatial-holdout F1 sanity check, and saves artifacts to active_learning/models/:
...
import model_core as mc  # run from active_learning/scripts/, or see sys.path shim below
