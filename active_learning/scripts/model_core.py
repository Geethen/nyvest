...
inference is also a dead end here. See active_learning/reports/timber_report.md.
...
AL_ROOT = REPO / "active_learning"
DATA_DIR = REPO / "data"
MODELS_DIR = AL_ROOT / "models"
AL_DATA_DIR = AL_ROOT / "data"
...
# persisted active-learning artifact paths
...
def make_model(iterations: int = 300, n_classes: int | None = None,
    ...
    here at all (no CUDA VMM); see active_learning/reports/timber_report.md.
